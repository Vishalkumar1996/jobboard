...
const CreateJobForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/employer/jobs", form, { withCredentials: true });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50 py-10">
      <div className="bg-white text-black rounded-lg p-8 w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="font-semibold  text-black-600 block mb-1">Job Title</label>
            <input
              name="title"
              value={form.title}
